...
协议文档参考：
  - 事件总览: .docs/queqiao/events/v2/README.md
  - Player 模型: .docs/queqiao/events/v2/model/player.md
  - Translate 模型: .docs/queqiao/events/v2/model/translate.md
  - PlayerJoinEvent: .docs/queqiao/events/v2/notice/player-join-event.md
  - PlayerQuitEvent: .docs/queqiao/events/v2/notice/player-quit-event.md
  - PlayerDeathEvent: .docs/queqiao/events/v2/notice/player-death-event.md
  - PlayerAchievementEvent: .docs/queqiao/events/v2/notice/player-achievement-event.md
  - PlayerChatEvent: .docs/queqiao/events/v2/message/player-chat-event.md
  - PlayerCommandEvent: .docs/queqiao/events/v2/message/player-command-event.md
'''
import time
